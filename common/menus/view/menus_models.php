<?php
    $models = ControllerModels::ctrGetModels();
?>
                ...
                <div class='card card-secondary card-outline panel-height' id='panel-content'>
                    ...
                    <div class='card-header car-header-double d-flex align-items-center' id='cardMainHeader'>
                        <div class='row justify-content-between w-100'>
                            <div class="col-sm-6">
                                <h5 class='mt-2 ml-2'><b>MODELS</b></h5>
                            </div>
                            <div class="col-sm-4">
                         <div class="row align-items-center justify-content-end pt-1">
                            ...
                            <div class='pr-3'>
                                <button type='button' class='btn btn-block btn-outline-primary btn-sm mt-1 buttonAdd' data-toggle='modal' data-target='#modelModalCreate'>
                                    Añadir Modelo
                                </button>
                            </div>
                        </div>
                            ...
                            <tbody>
                                <?php
                                    foreach ($models as $key => $value) {
                                        ...
                                        echo '<td class="align-middle">' . $value["model_name"] . '</td>';
                                        echo '<td class="align-middle">' . $value["menu_name"] . '</td>';
                                        echo '<td class="align-middle">' . $value["model_path"] . '</td>';
                                        echo '<td class="align-middle">' . $value["model_desc"] . '</td>';
                                        echo '  <td>
                                                    <div class="btn-group">
...
<script src="common/models/resources/models.js"></script>

<!-- MODALS -->
<?php
    // Create Model
    require_once (__DIR__.'/../../models/view/modals/model_modal_create.php');
?>