        ...
        <div class="card card-secondary card-outline panel-height" id='panel-content'>
            ...
            <div class="card-header car-header-double d-flex align-items-center" id="cardMainHeader">
                <div class="row justify-content-between w-100">
                    <div class="col-sm-6">
                        <h5 class="mt-2 ml-2"><b>CONTROL DE VISTAS</b></h5>
                    </div>
                    <div class="col-sm-4">
                    ...
                    <div class="pr-3">
                        <button type="button" class="btn btn-block btn-outline-primary btn-sm mt-1 buttonAdd" data-toggle="modal" data-target="#menusModalCreate" menuType=2>
                            Añadir Vista
                        </button>
                    </div>
                </div>
                    ...
                    <tbody>
                        <?php
                            ...
                            foreach ($elements as $key => $value) {
                                ...
                                echo '<td class="text-center alingn-middle"> <span class="material-symbols-outlined">' . $value['menu_icon'] . '</span></td>';
