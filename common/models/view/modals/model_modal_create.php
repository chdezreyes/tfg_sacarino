<!--  MENUS CREATE ITEM --- -->
<!-- The Modal -->
<div class="modal fade" id="modelModalCreate" role="dialog">
    ...
    <div class="modal-content">
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <div class="modal-header card-orange card-outline">
                <h5 class="row modal-title font-weight-bold align-items-center ml-2" id="modalTitle"><span class="material-symbols-outlined pr-2">instant_mix</span>Añadir Modelo</h5>
                    ...
                    <div class="row p-3">
                        ...
                        <div class="row w-100 justify-content-between mt-1 mb-2 ml-0 mr-0" id="divItemName">
                            <div class="col-sm-12 input-group mb-1 ml-0 mr-0 pl-0">
                                ...
                                <div class="col-sm-8">
                                    <input class="borderbottom w-100 pl-3" type="text" id="itemName" name="itemName" required placeholder="ModelNombre.php (use este patrón)">
                                </div>
                            </div>
                        </div>
            ...
            <?php
                ...
                $newMenuItem = new ControllerModels();
                $newMenuItem -> ctrCreateModelItem();
